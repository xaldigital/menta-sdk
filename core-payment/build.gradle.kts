...
android {
    namespace = "com.xaldigital.core_payment"
    compileSdk = 34
...
publishing {
    publications {
        create<MavenPublication>("github") {
            ...
            artifactId = "core-payment"
            version = "3.5.5"

            artifact("${layout.buildDirectory.get().asFile}/outputs/aar/com_menta_android_core_core_payment_3.5.5_core_payment-3.5.5.aar")

            pom {
                name = "Core Payment"
                description = "Dependencia que maneja el core para procesar transacciones."
